            ...
            <div class="card-body">
                <table class="table table-hover table-sm">
                    <caption>
                        <div class="row">
                            <div class="col-md-9">
                                List of Contact Types - Total Items {{ this.meta.total }}
                            </div>
                            <div class="col-md-3">
...
<script>
    const getContactTypes = (page, per_page, callback) => {
        const params = { page, per_page };

        axios.get('/api/contact-types', { params }).then(res => {
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            if (to.query.per_page == null) {
                getContactTypes(to.query.page, 10, (err, data) => {
                    next(vm => vm.setData(err, data));
                });
            } else {
                getContactTypes(to.query.page, to.query.per_page, (err, data) => {
                    next(vm => vm.setData(err, data));
                });
            }
        },
        ...
        beforeRouteUpdate (to, from, next) {
            getContactTypes(to.query.page, this.meta.per_page, (err, data) => {
        ...
        methods: {
            ...
            setData(err, { data: contactTypes, links, meta }) {
                this.pageNumbers = [];
