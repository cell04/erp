                ...
                <div class="card-body">
                    <table class="table table-hover table-sm">
                        <caption>
                            <div class="row">
                                <div class="col-md-9">
                                    List of Received Orders - Total Received Orders {{ this.meta.total }}
                                </div>
                                <div class="col-md-3">
...
<script>
    const getCorporations = (
        ...
        axios.get('/api/receive-orders', { params }).then(res => {
            console.log(res);
            ...
            goToFirstPage() {
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        searchColumnSt: this.searchColumnSt,
