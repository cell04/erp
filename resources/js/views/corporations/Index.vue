                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Street</label>
                                        <input type="text" class="form-control" v-model="searchColumnStreet" autocomplete="off" minlength="2" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>City</label>
                                        <input type="text" class="form-control" v-model="searchColumnCity" autocomplete="off" minlength="2" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>State</label>
                                        <input type="text" class="form-control" v-model="searchColumnState" autocomplete="off" minlength="2" maxlength="255">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="searchColumnZipCode" autocomplete="off" minlength="2" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Fax</label>
                                        <input type="text" class="form-control" v-model="searchColumnFax" autocomplete="off" minlength="2" maxlength="255">
                                    </div>
                                </div>
                            </div>
