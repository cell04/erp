            ...
            <div class="card-header clearfix">
               <div class="float-left">
                ...
                <div class="float-right">
                    <router-link class="btn-success btn-sm" :to="{ name: 'conversions.create' }">Create New Conversion</router-link>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" class="form-control" v-model="searchColumnFromValue" autocomplete="off" minlength="2" maxlength="255" required>
                            </div>
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            if (to.query.per_page == null) {
                getConversions(
                    to.query.page,
                    10,
                    to.query.searchColumnFromValue,
                    to.query.searchColumnFromName,
                    to.query.searchColumnToValue,
                    to.query.searchColumnToName,
                    to.query.order_by,
                    (err, data) => {
        ...
        beforeRouteUpdate (to, from, next) {
            getConversions(
                to.query.page,
                this.meta.per_page,
                this.searchColumnFromValue,
                this.searchColumnFromName,
                this.searchColumnToValue,
                this.searchColumnToName,
                this.order_by,
                (err, data) => {
            ...
            goToFirstPage() {
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        searchColumnFromValue: this.searchColumnFromValue,
                        searchColumnFromName: this.searchColumnFromName,
                        searchColumnToValue: this.searchColumnToValue,
                        searchColumnToName: this.searchColumnToName,
