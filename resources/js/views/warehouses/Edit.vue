        ...
        <div class="p-md-4">
            <div class="card">
                <div class="card-header">
                    <a class="text-success" href="" @click.prevent="viewWarehouse">Warehouses</a>
                    <a class="text-secondary"> / Edit Warehouse</a>
                </div>
                <div class="card-body">
                    <div v-if="ifReady">
                        <form v-on:submit.prevent="editWarehouse">
                            ...
                            <button type="button" class="btn btn-success btn-sm" @click.prevent.default="updateWarehouse"><i class="fas fa-edit"></i> Update Warehouse</button>
                        </form>
                    </div>
                    <div v-else>
                        <div class="progress">
