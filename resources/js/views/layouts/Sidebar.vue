    ...
    <ul class="nav flex-column sidebar-nav" style="margin-top: -4px;">
      <li class="nav-item">
        <span class="nav-link icon-white mainNavColor">
          ...
          <a href="http://accounting.tradesoft.ph">
            <i class="icon-white fas fa-calculator float-right pt-1"></i>
          </a>
        </span>
      </li>
      ...
      <li class="nav-item">
        <a
          ...
          :aria-expanded="this.expand.sales"
          aria-controls="sales"
          v-bind:class="isActive(this.salesRoute)"
        >
          ...
          <li class="nav-item">
            <router-link class="nav-link link" :to="{ name: 'quotations.index' }">
              <span class="sub-content">
                <i class="fas fa-caret-right pr-2"></i> Quotations
              </span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link link" :to="{ name: 'bid-sheets.index' }">
              <span class="sub-content">
                <i class="fas fa-caret-right pr-2"></i> Bid Sheets
              </span>
            </router-link>
          </li>
          <li class="nav-item">
      ...
      <li class="nav-item">
        <a
          ...
          v-bind:class="isActive(this.inventoryRoute)"
        >
      ...
      <li class="nav-item">
        <a
          ...
          data-toggle="collapse"
          aria-expanded="false"
          aria-controls="purchasing"
          v-bind:class="isActive(this.purchasingRoute)"
        >
